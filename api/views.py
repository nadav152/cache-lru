...
cache = Cache(size=3, default_ttl=60)
...
class BookViewSet(APIView):
    ...
    def get(self, request, pk=None):
        try:
            ...
            # adding a book to cache will renew its TTL if already in cache
            cache.set_object(pk, book)
